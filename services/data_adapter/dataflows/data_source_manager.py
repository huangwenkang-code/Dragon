...
# 导入统一日志系统
from shared.utils.logging_init import setup_dataflow_logging
logger = setup_dataflow_logging()

# 导入统一数据源编码
from shared.constants import DataSourceCode
...
class DataSourceManager:
    ...
    def _check_mongodb_enabled(self) -> bool:
        """检查是否启用MongoDB缓存"""
        from shared.configs.runtime_settings import use_app_cache_enabled
    ...
    def _identify_market_category(self, symbol: Optional[str]) -> Optional[str]:
        ...
        try:
            from shared.utils.stock_utils import StockUtils, StockMarket
    ...
    def _check_available_sources(self) -> List[ChinaDataSource]:
        ...
        if self.use_mongodb_cache and 'mongodb' in enabled_sources_in_db:
            try:
                from services.data_adapter.dataflows.cache.mongodb_cache_adapter import get_mongodb_cache_adapter
    ...
    def get_stock_info(self, symbol: str) -> Dict:
        ...
        try:
            from shared.configs.runtime_settings import use_app_cache_enabled  # type: ignore
    ...
    def get_stock_basic_info(self, stock_code: str = None) -> Optional[Dict[str, Any]]:
        ...
        if stock_code is None:
            ...
            try:
                # 尝试从 MongoDB 获取
                from shared.configs.database_manager import get_database_manager
...
def get_china_stock_data_unified(symbol: str, start_date: str, end_date: str) -> str:
    ...
    Returns:
        str: 格式化的股票数据
    """
    from shared.utils.logging_init import get_logger
